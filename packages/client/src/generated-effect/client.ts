...
type Endpoint3_4Request = Parameters<RawClient["server.session"]["session.cost"]>[0]
...
type Endpoint3_8Request = Parameters<RawClient["server.session"]["session.input.list"]>[0]
...
const Endpoint3_8 = (raw: RawClient["server.session"]) => (input: Endpoint3_8Input) =>
  raw["session.input.list"]({ params: { sessionID: input["sessionID"] } }).pipe(
    Effect.mapError(mapClientError),
    Effect.map((value) => value.data),
  )

type Endpoint3_9Request = Parameters<RawClient["server.session"]["session.input.revise"]>[0]
type Endpoint3_9Input = {
  readonly sessionID: Endpoint3_9Request["params"]["sessionID"]
  readonly messageID: Endpoint3_9Request["params"]["messageID"]
  readonly prompt: Endpoint3_9Request["payload"]["prompt"]
}
const Endpoint3_9 = (raw: RawClient["server.session"]) => (input: Endpoint3_9Input) =>
  raw["session.input.revise"]({
...
type Endpoint3_10Request = Parameters<RawClient["server.session"]["session.input.withdraw"]>[0]
type Endpoint3_10Input = {
  readonly sessionID: Endpoint3_10Request["params"]["sessionID"]
  readonly messageID: Endpoint3_10Request["params"]["messageID"]
}
const Endpoint3_10 = (raw: RawClient["server.session"]) => (input: Endpoint3_10Input) =>
  raw["session.input.withdraw"]({ params: { sessionID: input["sessionID"], messageID: input["messageID"] } }).pipe(
    Effect.mapError(mapClientError),
  )
...
type Endpoint3_12Request = Parameters<RawClient["server.session"]["session.shell"]>[0]
type Endpoint3_12Input = {
  readonly sessionID: Endpoint3_12Request["params"]["sessionID"]
  readonly id?: Endpoint3_12Request["payload"]["id"]
  readonly command: Endpoint3_12Request["payload"]["command"]
...
type Endpoint3_13Request = Parameters<RawClient["server.session"]["session.command"]>[0]
type Endpoint3_13Input = {
  readonly sessionID: Endpoint3_13Request["params"]["sessionID"]
  readonly id?: Endpoint3_13Request["payload"]["id"]
  readonly command: Endpoint3_13Request["payload"]["command"]
  readonly arguments?: Endpoint3_13Request["payload"]["arguments"]
  readonly agent?: Endpoint3_13Request["payload"]["agent"]
  readonly model?: Endpoint3_13Request["payload"]["model"]
  readonly files?: Endpoint3_13Request["payload"]["files"]
  readonly delivery?: Endpoint3_13Request["payload"]["delivery"]
}
...
type Endpoint3_14Request = Parameters<RawClient["server.session"]["session.share"]>[0]
...
type Endpoint3_15Request = Parameters<RawClient["server.session"]["session.unshare"]>[0]
...
type Endpoint3_17Request = Parameters<RawClient["server.session"]["session.wait"]>[0]
...
type Endpoint3_18Request = Parameters<RawClient["server.session"]["session.revert.stage"]>[0]
type Endpoint3_18Input = {
  readonly sessionID: Endpoint3_18Request["params"]["sessionID"]
  readonly messageID: Endpoint3_18Request["payload"]["messageID"]
  readonly files?: Endpoint3_18Request["payload"]["files"]
}
...
type Endpoint3_19Request = Parameters<RawClient["server.session"]["session.revert.clear"]>[0]
...
type Endpoint3_20Request = Parameters<RawClient["server.session"]["session.revert.commit"]>[0]
...
type Endpoint3_21Request = Parameters<RawClient["server.session"]["session.context"]>[0]
...
type Endpoint3_22Request = Parameters<RawClient["server.session"]["session.history"]>[0]
...
type Endpoint3_23Request = Parameters<RawClient["server.session"]["session.events"]>[0]
type Endpoint3_23Input = {
  readonly sessionID: Endpoint3_23Request["params"]["sessionID"]
  readonly after?: Endpoint3_23Request["query"]["after"]
}
...
type Endpoint3_24Request = Parameters<RawClient["server.session"]["session.interrupt"]>[0]
...
type Endpoint3_25Request = Parameters<RawClient["server.session"]["session.message"]>[0]
type Endpoint3_25Input = {
  readonly sessionID: Endpoint3_25Request["params"]["sessionID"]
  readonly messageID: Endpoint3_25Request["params"]["messageID"]
}
...
const adaptGroup3 = (raw: RawClient["server.session"]) => ({
  ...
  get: Endpoint3_3(raw),
  cost: Endpoint3_4(raw),
  switchAgent: Endpoint3_5(raw),
  switchModel: Endpoint3_6(raw),
  prompt: Endpoint3_7(raw),
  listInputs: Endpoint3_8(raw),
  reviseInput: Endpoint3_9(raw),
  withdrawInput: Endpoint3_10(raw),
  compact: Endpoint3_11(raw),
  shell: Endpoint3_12(raw),
  command: Endpoint3_13(raw),
  share: Endpoint3_14(raw),
  unshare: Endpoint3_15(raw),
  fork: Endpoint3_16(raw),
  wait: Endpoint3_17(raw),
  stage: Endpoint3_18(raw),
  clear: Endpoint3_19(raw),
  commit: Endpoint3_20(raw),
  context: Endpoint3_21(raw),
  history: Endpoint3_22(raw),
  events: Endpoint3_23(raw),
  interrupt: Endpoint3_24(raw),
...
type Endpoint18_0Request = Parameters<RawClient["server.workflow"]["workflow.list"]>[0]
...
const Endpoint18_0 = (raw: RawClient["server.workflow"]) => (input?: Endpoint18_0Input) =>
  raw["workflow.list"]({ query: { location: input?.["location"] } }).pipe(Effect.mapError(mapClientError))

type Endpoint18_1Request = Parameters<RawClient["server.workflow"]["workflow.run"]>[0]
type Endpoint18_1Input = {
  readonly id: Endpoint18_1Request["params"]["id"]
  readonly location?: Endpoint18_1Request["query"]["location"]
  readonly args?: Endpoint18_1Request["payload"]["args"]
  readonly budgetUsd?: Endpoint18_1Request["payload"]["budgetUsd"]
  readonly resumeFromRunId?: Endpoint18_1Request["payload"]["resumeFromRunId"]
}
const Endpoint18_1 = (raw: RawClient["server.workflow"]) => (input: Endpoint18_1Input) =>
  raw["workflow.run"]({
    params: { id: input["id"] },
    query: { location: input["location"] },
    payload: { args: input["args"], budgetUsd: input["budgetUsd"], resumeFromRunId: input["resumeFromRunId"] },
  }).pipe(Effect.mapError(mapClientError))

type Endpoint18_2Request = Parameters<RawClient["server.workflow"]["workflow.run.get"]>[0]
type Endpoint18_2Input = {
  readonly runID: Endpoint18_2Request["params"]["runID"]
...
const Endpoint18_2 = (raw: RawClient["server.workflow"]) => (input: Endpoint18_2Input) =>
  raw["workflow.run.get"]({ params: { runID: input["runID"] }, query: { location: input["location"] } }).pipe(
    Effect.mapError(mapClientError),
  )
