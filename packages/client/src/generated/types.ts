...
export type AgentsListOutput = {
  ...
  readonly data: ReadonlyArray<{
    ...
    readonly fallbackCircular?: boolean
    readonly request: {
...
export type SessionsPromptInput = {
  ...
  readonly id?: {
    ...
    readonly prompt: {
      ...
      readonly modelOverride?: { readonly id: string; readonly providerID: string; readonly variant?: string }
    }
...
export type SessionsPromptOutput = {
  readonly data: {
    ...
    readonly withdrawnSeq?: number
  }
}["data"]

export type SessionsListInputsInput = { readonly sessionID: { readonly sessionID: string }["sessionID"] }

export type SessionsListInputsOutput = {
  readonly data: ReadonlyArray<{
    readonly admittedSeq: number
    readonly id: string
    readonly sessionID: string
...
export type SessionsReviseInputInput = {
...
export type SessionsReviseInputOutput = {
  readonly data: {
    readonly admittedSeq: number
    readonly id: string
    readonly sessionID: string
...
export type SessionsWithdrawInputInput = {
  readonly sessionID: { readonly sessionID: string; readonly messageID: string }["sessionID"]
  readonly messageID: { readonly sessionID: string; readonly messageID: string }["messageID"]
}

export type SessionsWithdrawInputOutput = void
...
export type SessionsHistoryOutput = {
  readonly data: ReadonlyArray<
    ...
    | {
        readonly id: string
        readonly metadata?: { readonly [x: string]: JsonValue }
        readonly type: "session.next.prompt.withdrawn"
        readonly durable?: { readonly aggregateID: string; readonly seq: number; readonly version: number }
        readonly location?: { readonly directory: string; readonly workspaceID?: string }
    ...
    | {
        readonly id: string
        readonly metadata?: { readonly [x: string]: JsonValue }
        readonly type: "session.next.message.forked"
        readonly durable?: { readonly aggregateID: string; readonly seq: number; readonly version: number }
        readonly location?: { readonly directory: string; readonly workspaceID?: string }
        readonly data: {
          readonly timestamp: number
