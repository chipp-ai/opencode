...
export class Service extends ConfigService.Service<Service>()("@opencode/RuntimeFlags", {
  ...
  // V2 sessions are the default and no longer follow OPENCODE_EXPERIMENTAL; the legacy env var name
  // is kept as the opt-out escape hatch (OPENCODE_EXPERIMENTAL_V2_SESSION=false falls back to V1).
