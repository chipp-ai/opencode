...
export const Definitions = {
  ...
  session_find: keybind("<leader>f", "Find text in the current session"),
  session_find_next: keybind("return,up,ctrl+p", "Jump to the next (older) find match"),
  session_find_previous: keybind("shift+return,down,ctrl+n", "Jump to the previous (newer) find match"),
  session_find_close: keybind("escape,ctrl+c", "Close session find"),
  ...
  prompt_paste_toggle: keybind("none", "Expand or collapse pasted text"),
...
export const CommandMap = {
  ...
  session_find_next: "session.find.next",
  session_find_previous: "session.find.previous",
  session_find_close: "session.find.close",
  ...
  prompt_paste_toggle: "prompt.paste.toggle",
