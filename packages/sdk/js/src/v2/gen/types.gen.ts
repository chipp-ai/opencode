...
export type SyncEventSessionNextMessageForked = {
  type: "sync"
  id: string
  syncEvent: {
    type: "session.next.message.forked.1"
    id: string
    seq: number
    aggregateID: string
    data: {
...
export type SessionNextMessageForked = {
  id: string
  metadata?: {
    [key: string]: unknown
  }
...
export type EventSessionNextMessageForked = {
  id: string
  type: "session.next.message.forked"
  properties: {
    timestamp: number
